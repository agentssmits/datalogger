...
def addCustomTabs(self, count, start = 3):
	...
	for i in range (1, count+1):
		...
		customSelectionCheckBoxArr[5].setText(_translate("MainWindow", "channel 5"))
		customSelectionCheckBoxArr[6].setText(_translate("MainWindow", "channel 6"))
		customSelectionCheckBoxArr[7].setText(_translate("MainWindow", "channel 7"))
		customSelectionCheckBoxArr[1].setText(_translate("MainWindow", "channel 1"))
		customSelectionCheckBoxArr[10].setText(_translate("MainWindow", "channel 10"))
		customSelectionCheckBoxArr[8].setText(_translate("MainWindow", "channel 8"))
		customSelectionCheckBoxArr[9].setText(_translate("MainWindow", "channel 9"))
		customSelectionCheckBoxArr[11].setText(_translate("MainWindow", "channel 11"))
		customSelectionCheckBoxArr[4].setText(_translate("MainWindow", "channel 4"))
		customSelectionCheckBoxArr[3].setText(_translate("MainWindow", "channel 3"))
		customSelectionCheckBoxArr[2].setText(_translate("MainWindow", "channel 2"))
		customSelectionCheckBoxArr[0].setText(_translate("MainWindow", "channel 0"))
